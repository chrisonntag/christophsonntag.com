...
},{"./gsap-core.js":"OKU8","./CSSPlugin.js":"QIAl"}],"AWxZ":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./esm/components/core/core-class":"fy7h","./esm/components/virtual/virtual":"lPeZ","./esm/components/keyboard/keyboard":"UABp","./esm/components/mousewheel/mousewheel":"L2R1","./esm/components/navigation/navigation":"DoDY","./esm/components/pagination/pagination":"J0PB","./esm/components/scrollbar/scrollbar":"Z0BC","./esm/components/parallax/parallax":"j5qV","./esm/components/zoom/zoom":"YM4o","./esm/components/lazy/lazy":"PYk5","./esm/components/controller/controller":"mvHS","./esm/components/a11y/a11y":"L3uL","./esm/components/history/history":"TBmA","./esm/components/hash-navigation/hash-navigation":"zI9Y","./esm/components/autoplay/autoplay":"BO68","./esm/components/effect-fade/effect-fade":"N4V4","./esm/components/effect-cube/effect-cube":"DYMQ","./esm/components/effect-flip/effect-flip":"uwwl","./esm/components/effect-coverflow/effect-coverflow":"fg0O","./esm/components/thumbs/thumbs":"gpDU"}],"xLME":[function(require,module,exports) {
...
var initPageTransitions = function initPageTransitions() {
  ...
  var navdemos = Array.from(document.querySelectorAll(".demos__links .demo"));
...
var _default = initPageTransitions;
exports.default = _default;
...
var _initPageTransitions = _interopRequireDefault(require("./initPageTransitions"));
...
var Slider = /*#__PURE__*/function () {
  function Slider() {
    ...
    (0, _initPageTransitions.default)();
    this.initDemo();
    this.initSwiper();
  ...
  _createClass(Slider, [{
    ...
    value: function initDemo() {
      ...
      var onSwiperMouseEnter = function onSwiperMouseEnter(e) {
        ...
        if (!_this.clientY) _this.clientY = e.clientY;
        var startRotation;
        ...
        _gsap.gsap.set(_this.cursorIcon, {
          rotation: startRotation
        });

        _this.cursorSide = _this.clientX > window.innerWidth / 2 ? "right" : "left";

        _gsap.gsap.to(_this.cursorIcon, {
          rotation: _this.cursorSide === "right" ? 0 : -180,
          scale: 1,
      ...
      var onSwitchSwiperSides = function onSwitchSwiperSides() {
        if (_this.cursorInsideSwiper) {
          _gsap.gsap.to(_this.cursorIcon, {
            duration: _this.animationDuration,
            rotation: _this.cursorSide === "right" ? -180 : 0,
            ease: _this.easing
          });

          _this.cursorSide = _this.cursorSide === "left" ? "right" : "left";
        }

        if (!_this.cursorInsideSwiper) {
          _this.cursorInsideSwiper = true;
        }
      };
    ...
    value: function initSwiper() {
      ...
      //const { Swiper } = window;
      this.swiper = new _swiper.Swiper(".swiper-container", {
        loop: true,
        direction: "horizontal",
        slidesPerView: "auto",
        spaceBetween: 40,
      ...
      this.swiper.on("touchMove", function (e) {
        var clientX = e.clientX,
            clientY = e.clientY;
        _this2.clientX = clientX;
        _this2.clientY = clientY;
        _this2.cursorSide = _this2.clientX > window.innerWidth / 2 ? "right" : "left";

        _gsap.gsap.to(_this2.cursorIcon, {
          duration: _this2.animationDuration,
          rotation: _this2.cursorSide === "right" ? 0 : -180,
          ease: _this2.easing
        });
      });
      this.bumpCursorTween = _gsap.gsap.to(this.cursor, {
        duration: 0.1,
        scale: 0.85,
...
},{"gsap":"QSxm","swiper":"FJWo","lazysizes":"xLME","./initPageTransitions":"MCsd"}]},{},["A2T1"], null)